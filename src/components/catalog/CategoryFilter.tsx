...
const CATEGORY_ICONS: Record<string, React.ReactNode> = {
  ...
  "polo-krekli": <Shirt className="h-5 w-5" />,
  "krekli": <Shirt className="h-5 w-5" />,
  "dzemperi-hudiji": <Layers className="h-5 w-5" />,
  "jakas": <Wind className="h-5 w-5" />,
  "virsjakas": <Wind className="h-5 w-5" />,
  "vestes": <Wind className="h-5 w-5" />,
  "bikses-sorti": <Layers className="h-5 w-5" />,
  "kleitas-svārki": <Shirt className="h-5 w-5" />,
  "cepures": <HardHat className="h-5 w-5" />,
  "šalles-lakati": <Wind className="h-5 w-5" />,
  "somas": <ShoppingBag className="h-5 w-5" />,
  "aksesuari": <ShoppingBag className="h-5 w-5" />,
  "darba-apgerbi": <HardHat className="h-5 w-5" />,
  ...
  "dvieli": <Layers className="h-5 w-5" />,
  "priekšauti": <Layers className="h-5 w-5" />,
  "softshell": <Wind className="h-5 w-5" />,
  "fleece": <Layers className="h-5 w-5" />,
};
