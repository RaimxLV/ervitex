...
import { Mail, Phone, MapPin, Lock, ShieldCheck, Facebook, Instagram, Share2, MessageCircle } from "lucide-react";
...
const socials = [
  { icon: Facebook, href: "https://www.facebook.com/ervitex", label: "Facebook" },
  { icon: Instagram, href: "https://www.instagram.com/t_bode_lv/", label: "Instagram" },
];
