...
import workwearImg from "@/assets/bento/workwear-action.webp";
import sportswearImg from "@/assets/bento/sportswear-action.webp";
import hoodiesImg from "@/assets/bento/hoodies-action.jpg";
import capsImg from "@/assets/bento/caps-action.webp";
import bagsImg from "@/assets/bento/bags-action.webp";
...
const TILES: Tile[] = [
  { id: "tshirts", lv: "T-krekli", en: "T-shirts", image: tshirtsImg, link: cat(["T-shirts"]) },
  { id: "polo", lv: "Polo krekli", en: "Polos", image: poloImg, link: cat(["Polos"]) },
  {
    id: "hoodies",
    lv: "Hūdiji un džemperi",
    en: "Hoodies & sweats",
    image: hoodiesImg,
    link: cat(["Hoodies", "Sweaters"]),
  },
  { id: "jackets", lv: "Virsjakas un vestes", en: "Jackets & vests", image: jacketsImg, link: cat(["Jackets", "Vests"]) },
  { id: "workwear", lv: "Darba apģērbs", en: "Workwear", image: workwearImg, link: cat(["Workwear", "Coveralls", "Safety"]) },
  {
    id: "sport",
    lv: "Bikses un šorti",
    en: "Bottoms",
    image: sportswearImg,
    link: cat(["Trousers", "Shorts"]),
  },
  { id: "caps", lv: "Cepures", en: "Caps & beanies", image: capsImg, link: cat(["Caps & Hats"]) },
  {
    id: "bags",
    lv: "Somas",
    en: "Bags",
    image: bagsImg,
    link: cat(["Bags", "Tote Bags", "Backpacks", "Sports Bags", "Travel Bags"]),
  },
  {
    id: "drinkware",
  ...
  },
  {
    ...
    en: "Promo & gifts",
    image: promoImg,
    link: cat(["Notebooks", "Ballpoint Pens", "Umbrellas", "Gift Sets"]),
  },
