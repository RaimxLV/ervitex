...
BEGIN
  ...
  -- NWG contract price is stored as the public price excluding VAT.
  -- The frontend adds 21% VAT exactly once for the inclusive display.
  INSERT INTO public.catalog_variant_prices (source, sku, style_code, color_code, size, retail_price, currency)
  SELECT 'nwg', k.sku, k.product_number, v.color_code, k.size,
         ROUND((k.purchase_price * 1.67)::numeric, 2),
